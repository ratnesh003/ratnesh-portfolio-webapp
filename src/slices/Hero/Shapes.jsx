...
function Geometries() {
    ...
    const soundEffects = [
        new Audio("/sound/audio1.ogg"),
        new Audio("/sound/audio2.ogg"),
        new Audio("/sound/audio3.ogg"),
        new Audio("/sound/audio4.ogg"),
        new Audio("/sound/audio5.ogg"),
        new Audio("/sound/audio6.ogg"),
        new Audio("/sound/audio7.ogg"),
