...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate w-[320px] transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [aspect-ratio:17/23] [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
